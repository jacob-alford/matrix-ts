 ...
 * @category Instances
 */
export const Module: Mod.Module<C.Complex, Vec4> = V.getModule(C.Field)(4)

/**
 * @since 1.0.0
 * @category Instances
 */
export const VectorField: VecSpc.VectorSpace<C.Complex, Vec4> = V.getVectorField(C.Field)(
  4
)
