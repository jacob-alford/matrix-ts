 ...
 * @category Instances
 */
export const Module: Mod.Module<C.Complex, Vec3> = V.getModule(C.Field)(3)

/**
 * @since 1.0.0
 * @category Instances
 */
export const VectorField: VecSpc.VectorSpace<C.Complex, Vec3> = V.getVectorField(C.Field)(
  3
)
